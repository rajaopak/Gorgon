...
public class ConfigUpdater {
    ...
    private static void write(FileConfiguration newConfig, FileConfiguration oldConfig, Map<String, String> comments, List<String> ignoredSections, BufferedWriter writer, Yaml yaml)
            throws IOException {
        outer:
                    ...
                    if (keyBuilder.toString().equals(ignoredSection)) {
                        ...
                        if (value instanceof ConfigurationSection)
                            appendSection(
                                    ...
                                    new StringBuilder(getPrefixSpaces(lastLineIndentCount)),
                                    yaml);
    ...
    private static void appendSection(StringBuilder builder, ConfigurationSection section, StringBuilder prefixSpaces, Yaml yaml) {
        builder.append(prefixSpaces)
                .append(getKeyFromFullKey(Objects.requireNonNull(section.getCurrentPath())))
                .append(":");
        ...
        for (String key : keys) {
            ...
            if (value instanceof ConfigurationSection) {
                ...
                builder.append(
                        getListAsString((List<Object>) value, actualKey, prefixSpaces.toString(), yaml));
            } else {
